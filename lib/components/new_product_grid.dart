...
class NewProductGrid extends StatefulWidget {
  ...
  const NewProductGrid({super.key, required this.foodType});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream:
        FirebaseFirestore.instance.collection('products').where('foodType',isEqualTo: widget.foodType).snapshots(),
